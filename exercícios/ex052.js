...
function removePropriedade(obj={}, propIndesejada='') {
    const objNovo = Object.assign({}, obj)
    delete objNovo[propIndesejada];
    return objNovo;
}    

console.log(removePropriedade({a: 1, b: 2}, "a"));
console.log(removePropriedade({ id: 20, nome: "caneta", descricao: "Não preenchido" }, "descricao"));
console.log(removePropriedade({a: 1, b: 2}));
